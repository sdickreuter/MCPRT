...
lense1.shift(dx=lense1._calc_f_front()+lense1.front.points[:,0].min(),dy=2)
lense2.shift(dx=lense1.back.points[:,0].max()+lense1._calc_f_back()+lense2._calc_f_front(),dy=2)
...
num = 100
ys = np.linspace(-0.5, 0.5, num)+2.0
